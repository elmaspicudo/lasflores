...
use protecno\escuelaBundle\Entity\curso;
use protecno\escuelaBundle\Form\cursoType;
...
class cursoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('escuelaBundle:curso')->findAll();

        return $this->render('escuelaBundle:curso:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('escuelaBundle:curso:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('escuelaBundle:curso')->find($id);
        ...
        return $this->render('escuelaBundle:curso:show.html.twig', array(
            'entity'      => $entity,
