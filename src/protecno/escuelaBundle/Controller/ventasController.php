...
use protecno\escuelaBundle\Entity\ventas;
use protecno\escuelaBundle\Form\ventasType;
...
class ventasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('escuelaBundle:ventas')->findAll();

        return $this->render('escuelaBundle:ventas:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('escuelaBundle:ventas:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('escuelaBundle:ventas')->find($id);
        ...
        return $this->render('escuelaBundle:ventas:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('escuelaBundle:ventas:edit.html.twig', array(
            'entity'      => $entity,
