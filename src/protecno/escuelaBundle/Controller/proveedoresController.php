...
use protecno\escuelaBundle\Entity\proveedores;
use protecno\escuelaBundle\Form\proveedoresType;
...
class proveedoresController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('escuelaBundle:proveedores')->findAll();

        return $this->render('escuelaBundle:proveedores:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('escuelaBundle:proveedores:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('escuelaBundle:proveedores')->find($id);
        ...
        return $this->render('escuelaBundle:proveedores:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('escuelaBundle:proveedores:edit.html.twig', array(
            'entity'      => $entity,
